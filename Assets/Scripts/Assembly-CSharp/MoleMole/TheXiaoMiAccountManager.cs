...
namespace MoleMole
{
	public class TheXiaoMiAccountManager : TheBaseAccountManager
	{
		private const float PRICE_UNIT_RATE = 1f;

		public const bool DebugBuild = false;

		public TheXiaoMiAccountManager()
		{
			_accountDelegate = new TheXiaoMiAccountDelegate();
		}

		public override void Init()
		{
			base.AccountType = (AccountType)6;
