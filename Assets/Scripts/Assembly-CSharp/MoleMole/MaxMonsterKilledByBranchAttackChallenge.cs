...
namespace MoleMole
{
	public class MaxMonsterKilledByBranchAttackChallenge : BaseLevelChallenge
	{
		...
		public MaxMonsterKilledByBranchAttackChallenge(LevelChallengeHelperPlugin helper, LevelChallengeMetaData metaData)
