...
namespace MoleMole
{
	public class TheVivoAccountManager : TheBaseAccountManager
	{
		...
		{
			_accountDelegate = new TheVivoAccountDelegate();
		}

		public override void Init()
		{
			base.AccountType = (AccountType)9;
		...
		public override bool Pay(string productID, string productName, float productPrice)
		{
			...
			_accountDelegate.pay(productID, productName, productPrice * 1f, Guid.NewGuid().ToString("N"), userId.ToString(), oaServerUrl + "/callback/vivo", "AccountEventListener", "PayFinishedCallBack", null);
			return false;
		}
