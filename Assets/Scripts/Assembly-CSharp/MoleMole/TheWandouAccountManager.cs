...
namespace MoleMole
{
	public class TheWandouAccountManager : TheBaseAccountManager
	{
		private const float PRICE_UNIT_RATE = 1f;

		public static bool DebugBuild;

		public TheWandouAccountManager()
		{
			_accountDelegate = new TheWandouAccountDelegate();
		}

		public override void Init()
		{
			base.AccountType = (AccountType)15;
		...
		public override void PayFinishedCallBack(string param)
		{
			...
			else if (!int.TryParse(param, out result) || result == 1)
			{
