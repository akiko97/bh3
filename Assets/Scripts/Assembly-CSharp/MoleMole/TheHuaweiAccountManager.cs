...
namespace MoleMole
{
	public class TheHuaweiAccountManager : TheBaseAccountManager
	{
		public const bool DebugBuild = false;

		public TheHuaweiAccountManager()
		{
			_accountDelegate = new TheHuaweiAccountDelegate();
		}

		public override void Init()
		{
			base.AccountType = (AccountType)7;
