...
namespace MoleMole
{
	public class TheOppoAccountManager : TheBaseAccountManager
	{
		...
		{
			_accountDelegate = new TheOppoAccountDelegate();
		}

		public override void Init()
		{
			base.AccountType = (AccountType)8;
		...
		public override bool Pay(string productID, string productName, float productPrice)
		{
			...
			_accountDelegate.pay(productID, productName, productPrice, Guid.NewGuid().ToString("N"), userId.ToString(), oaServerUrl + "/callback/oppo", "AccountEventListener", "PayFinishedCallBack", null);
			return false;
		}
