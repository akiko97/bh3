namespace MoleMole.Config
{
	...
	public class SetLocomotionFloat : ConfigAbilityAction, IHashable
	{
		public string Param;
		...
		{
			abilityPlugin.SetLocomotionFloatHandler(actionConfig, instancedAbility, instancedModifier, target, evt);
		}
	}
}
