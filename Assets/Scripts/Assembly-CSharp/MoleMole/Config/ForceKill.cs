namespace MoleMole.Config
{
	...
	public class ForceKill : ConfigAbilityAction, IHashable
	{
		public KillEffect KillEffect;

		public void ObjectContentHashOnto(ref int lastHash)
		{
			HashUtils.ContentHashOnto((int)KillEffect, ref lastHash);
		...
		{
			abilityPlugin.ForceKillHandler(actionConfig, instancedAbility, instancedModifier, target, evt);
		}
	}
}
