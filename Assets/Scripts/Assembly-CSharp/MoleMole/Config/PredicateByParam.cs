namespace MoleMole.Config
{
	...
	public class PredicateByParam : BaseUtilityAction, IHashable
	{
		public string Param;
		...
		{
			abilityPlugin.PredicateByParamHandler(actionConfig, instancedAbility, instancedModifier, target, evt);
		}
	}
}
