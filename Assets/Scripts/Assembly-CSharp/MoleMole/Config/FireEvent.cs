namespace MoleMole.Config
{
	...
	public class FireEvent : BaseUtilityAction, IHashable
	{
		public string EvtCategory;

		public void ObjectContentHashOnto(ref int lastHash)
		{
			HashUtils.ContentHashOnto(EvtCategory, ref lastHash);
		...
		{
			abilityPlugin.FireEventHandler(actionConfig, instancedAbility, instancedModifier, target, evt);
		}
	}
}
