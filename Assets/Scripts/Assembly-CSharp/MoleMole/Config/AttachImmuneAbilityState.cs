namespace MoleMole.Config
{
	...
	public class AttachImmuneAbilityState : ConfigAbilityAction, IHashable
	{
		public AbilityState ImmuneState;

		public bool ClearAppliedState;

		public void ObjectContentHashOnto(ref int lastHash)
		{
			HashUtils.ContentHashOnto((int)ImmuneState, ref lastHash);
			HashUtils.ContentHashOnto(ClearAppliedState, ref lastHash);
		...
		{
			abilityPlugin.AttachImmuneAbilityStateHandler(actionConfig, instancedAbility, instancedModifier, target, evt);
		}
	}
}
