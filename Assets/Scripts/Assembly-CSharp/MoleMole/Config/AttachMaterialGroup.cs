namespace MoleMole.Config
{
	...
	public class AttachMaterialGroup : ConfigAbilityAction, IHashable
	{
		public string MaterialGroupName;

		public void ObjectContentHashOnto(ref int lastHash)
		{
			HashUtils.ContentHashOnto(MaterialGroupName, ref lastHash);
		...
		{
			abilityPlugin.AttachMaterialGroupHandler(actionConfig, instancedAbility, instancedModifier, target, evt);
		}
	}
}
