namespace MoleMole.Config
{
	...
	public class AttachNoCollision : ConfigAbilityAction, IHashable
	{
		...
		{
			abilityPlugin.AttachNoCollisionHandler(actionConfig, instancedAbility, instancedModifier, target, evt);
		}
	}
}
