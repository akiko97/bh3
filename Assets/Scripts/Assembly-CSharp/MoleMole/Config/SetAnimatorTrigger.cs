namespace MoleMole.Config
{
	...
	public class SetAnimatorTrigger : ConfigAbilityAction, IHashable
	{
		...
		{
			abilityPlugin.SetAnimatorTriggerHandler(actionConfig, instancedAbility, instancedModifier, target, evt);
		}
		...
		{
			output = string.Format("{0} 对 {1} 设置 Animator Trigger {2}", Miscs.GetDebugActorName(instancedAbility.caster), Miscs.GetDebugActorName(target), TriggerID);
			return true;
		}
	}
}
