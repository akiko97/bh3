namespace MoleMole.Config
{
	...
	public class AttachAnimEventPredicate : ConfigAbilityAction, IHashable
	{
		...
		{
			abilityPlugin.AttachAnimEventPredicateHandler(actionConfig, instancedAbility, instancedModifier, target, evt);
		}
	}
}
