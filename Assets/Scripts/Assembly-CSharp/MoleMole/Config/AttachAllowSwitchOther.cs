namespace MoleMole.Config
{
	...
	public class AttachAllowSwitchOther : ConfigAbilityAction, IHashable
	{
		public bool AllowSwitchOther;

		public void ObjectContentHashOnto(ref int lastHash)
		{
			HashUtils.ContentHashOnto(AllowSwitchOther, ref lastHash);
		...
		{
			abilityPlugin.SetAllowSwitchOther(actionConfig, instancedAbility, instancedModifier, target, evt);
		}
	}
}
