namespace MoleMole.Config
{
	...
	public class HitExplodeRoundBulletMixin : HitExplodeBulletMixin, IHashable
	{
		...
		{
			HashUtils.ContentHashOnto(RadAngle, ref lastHash);
			HashUtils.ContentHashOnto(CenterSpeed, ref lastHash);
			HashUtils.ContentHashOnto(CenterTraceRadial, ref lastHash);
