namespace MoleMole.Config
{
	...
	public class AttachModifier : ConfigAbilityAction, IHashable
	{
		...
		{
			abilityPlugin.AttachModifierHandler(actionConfig, instancedAbility, instancedModifier, target, evt);
		}
	}
}
