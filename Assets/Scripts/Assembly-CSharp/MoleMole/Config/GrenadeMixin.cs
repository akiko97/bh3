namespace MoleMole.Config
{
	...
	public class GrenadeMixin : HitExplodeBulletMixin, IHashable
	{
		public float Offset;
		...
		{
			HashUtils.ContentHashOnto(Offset, ref lastHash);
			HashUtils.ContentHashOnto(DelayTime, ref lastHash);
			HashUtils.ContentHashOnto(Gravity, ref lastHash);
			HashUtils.ContentHashOnto(Elasticity, ref lastHash);
		...
		{
			return new AbilityGrenadeMixin(instancedAbility, instancedModifier, this);
		}
	}
}
