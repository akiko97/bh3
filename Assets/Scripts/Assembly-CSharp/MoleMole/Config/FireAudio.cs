namespace MoleMole.Config
{
	...
	public class FireAudio : ConfigAbilityAction, IHashable
	{
		public string AudioPattern;

		public void ObjectContentHashOnto(ref int lastHash)
		{
			HashUtils.ContentHashOnto(AudioPattern, ref lastHash);
		...
		{
			abilityPlugin.FireAudioHandler(actionConfig, instancedAbility, instancedModifier, target, evt);
		}
	}
}
