namespace MoleMole.Config
{
	...
	public class AttachStageTint : ConfigAbilityAction, IHashable
	{
		public string RenderDataName;

		public float TransitDuration = 0.5f;

		public void ObjectContentHashOnto(ref int lastHash)
		{
			HashUtils.ContentHashOnto(RenderDataName, ref lastHash);
			HashUtils.ContentHashOnto(TransitDuration, ref lastHash);
		...
		{
			abilityPlugin.AttachTintHandler(actionConfig, instancedAbility, instancedModifier, target, evt);
		}
	}
}
