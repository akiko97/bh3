	...
	public class AvatarSkillButtonHoldChargeAnimatorMixin : BaseAvatarSkillButtonHoldChargeAnimatorMixin, IHashable
	{
		...
		public void ObjectContentHashOnto(ref int lastHash)
		{
			if (ChargeLoopDurations != null)
			{
				...
				foreach (float value in chargeLoopDurations)
				{
			...
			if (BeforeSkillIDs != null)
			{
				...
				foreach (string value2 in beforeSkillIDs)
				{
			...
			if (ChargeLoopSkillIDs != null)
			{
				...
				foreach (string value3 in chargeLoopSkillIDs)
				{
			...
			if (AfterSkillIDs != null)
			{
				...
				foreach (string value4 in afterSkillIDs)
				{
			...
			if (TransientSkillIDs != null)
			{
				...
				foreach (string value5 in transientSkillIDs)
				{
			...
			if (ChargeSubTargetAmount != null)
			{
				...
				foreach (int value6 in chargeSubTargetAmount)
				{
			...
			if (ChargeLoopAudioPatterns != null)
			{
				...
				foreach (string value7 in chargeLoopAudioPatterns)
				{
			...
			if (ChargeSwitchAudioPatterns != null)
			{
				...
				foreach (string value8 in chargeSwitchAudioPatterns)
				{
