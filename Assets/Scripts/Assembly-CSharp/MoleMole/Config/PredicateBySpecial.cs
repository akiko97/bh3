namespace MoleMole.Config
{
	...
	public class PredicateBySpecial : BaseUtilityAction, IHashable
	{
		...
		{
			IsEveryAvatarHasDifferenctClass = 0,
			IsEveryAvatarHasDifferenctRoleName = 1,
			IsEveryAvatarHasDifferenctNature = 2,
			IsEveryAvatarHasSameNature = 3
		}
		...
		{
			HashUtils.ContentHashOnto((int)Special, ref lastHash);
			HashUtils.ContentHashOnto((int)SameNature, ref lastHash);
			if (Actions != null)
			{
