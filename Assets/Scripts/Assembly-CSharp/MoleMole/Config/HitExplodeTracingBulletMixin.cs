namespace MoleMole.Config
{
	...
	public class HitExplodeTracingBulletMixin : HitExplodeBulletMixin, IHashable
	{
		...
		public new void ObjectContentHashOnto(ref int lastHash)
		{
			...
			HashUtils.ContentHashOnto(TurnStartDelay, ref lastHash);
			HashUtils.ContentHashOnto(TraceStartDelay, ref lastHash);
			HashUtils.ContentHashOnto(RandomOffsetDistance, ref lastHash);
			HashUtils.ContentHashOnto(RandomHeight, ref lastHash);
			HashUtils.ContentHashOnto(IsRandomTarget, ref lastHash);
			HashUtils.ContentHashOnto(IsRandomInit, ref lastHash);
			HashUtils.ContentHashOnto(IsRandomInitCone, ref lastHash);
			HashUtils.ContentHashOnto(TraceY, ref lastHash);
			HashUtils.ContentHashOnto(TraceRootNode, ref lastHash);
