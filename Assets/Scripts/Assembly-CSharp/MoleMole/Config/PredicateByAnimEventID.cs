namespace MoleMole.Config
{
	...
	public class PredicateByAnimEventID : BaseUtilityAction, IHashable
	{
		...
		{
			abilityPlugin.PredicateByAnimEventIDHandler(actionConfig, instancedAbility, instancedModifier, target, evt);
		}
	}
}
