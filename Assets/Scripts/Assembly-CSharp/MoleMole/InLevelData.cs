...
namespace MoleMole
{
	...
	{
		public const uint POLE_CONT_CAMERA_TYPE = 1u;
		...
		public static readonly Vector3[] SINGLE_MODE_AVATAR_INIT_POS_LIST = new Vector3[3]
		{
			Vector3.zero,
			CREATE_INIT_POS,
			CREATE_INIT_POS
		...
		public static readonly Vector3[] MUTIL_MODE_AVATAR_INIT_POS_LIST = new Vector3[3]
		{
			Vector3.zero,
		...
		public static readonly Vector3[] MUTIL_REMOTE_MODE_AVATAR_INIT_POS_LIST = new Vector3[3]
		{
			Vector3.zero,
			Vector3.zero,
			Vector3.zero
		...
		public static LayerMask GetLayerMask(ushort category)
		{
			...
			{
			case 3:
				return 1 << AVATAR_LAYER;
			case 4:
				return 1 << MONSTER_LAYER;
			case 7:
				return 1 << PROP_LAYER;
			default:
				return 0;
		...
		public static LayerMask GetHitboxLayerMask(ushort category)
		{
			...
			{
			case 3:
				return 1 << AVATAR_HITBOX_LAYER;
			case 4:
				return 1 << MONSTER_HITBOX_LAYER;
			case 7:
				return 1 << PROP_HITBOX_LAYER;
			default:
				return 0;
			}
		}
