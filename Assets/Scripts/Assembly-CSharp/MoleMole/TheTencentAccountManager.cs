...
namespace MoleMole
{
	public class TheTencentAccountManager : TheBaseAccountManager
	{
		public const bool DebugBuild = false;

		public TheTencentAccountManager()
		{
			_accountDelegate = new TheTencentAccountDelegate();
		}

		public override void Init()
		{
			base.AccountType = (AccountType)5;
