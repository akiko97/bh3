...
namespace MoleMole
{
	...
	public class WeaponMetaData : IHashable
	{
		...
		public readonly int branchType;

		public readonly string bodyMod;
		...
		public WeaponMetaData(int ID, string name, int rarity, int maxRarity, int subRarity, int subMaxRarity, int cost, int powerType, int maxLv, int expType, float sellPriceBase, float sellPriceAdd, float gearExpProvideBase, float gearExpPorvideAdd, string weaponType, int baseType, int branchType, string bodyMod, string displayTitle, string displayDescription, int displayNumber, string iconPath, string imagePath, float HPBase, float HPAdd, float SPBase, float SPAdd, float attackBase, float attackAdd, float defenceBase, float defenceAdd, float criticalBase, float criticalAdd, float durabilityMax, float durabilityDecrease, float repairPriceBase, float repairPriceAdd, int balance, List<string> evoMaterial, int evoID, int prop1ID, float prop1Param1, float prop1Param2, float prop1Param3, float prop1Param1Add, float prop1Param2Add, float prop1Param3Add, int prop2ID, float prop2Param1, float prop2Param2, float prop2Param3, float prop2Param1Add, float prop2Param2Add, float prop2Param3Add, int prop3ID, float prop3Param1, float prop3Param2, float prop3Param3, float prop3Param1Add, float prop3Param2Add, float prop3Param3Add)
		{
			this.ID = ID;
			this.name = name;
			this.rarity = rarity;
		...
		public void ObjectContentHashOnto(ref int lastHash)
		{
			...
			HashUtils.ContentHashOnto(weaponType, ref lastHash);
			HashUtils.ContentHashOnto(baseType, ref lastHash);
			HashUtils.ContentHashOnto(branchType, ref lastHash);
			HashUtils.ContentHashOnto(bodyMod, ref lastHash);
			...
			HashUtils.ContentHashOnto(balance, ref lastHash);
			if (evoMaterial != null)
			{
