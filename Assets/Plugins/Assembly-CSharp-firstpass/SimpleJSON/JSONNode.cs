...
namespace SimpleJSON
{
	public class JSONNode
	{
		...
		{
			using (BZip2OutputStream bZip2OutputStream = new BZip2OutputStream(aData))
			{
				bZip2OutputStream.IsStreamOwner = false;
				SaveToStream(bZip2OutputStream);
		...
		public string SaveToCompressedBase64()
		{
			...
			{
				SaveToCompressedStream(memoryStream);
		...
		{
			BZip2InputStream aData2 = new BZip2InputStream(aData);
			return LoadFromStream(aData2);
		}
		...
		public static JSONNode LoadFromCompressedFile(string aFileName)
		{
			...
			{
				return LoadFromCompressedStream(aData);
			}
		}
		...
		public static JSONNode LoadFromCompressedBase64(string aBase64)
		{
			...
			memoryStream.Position = 0L;
			return LoadFromCompressedStream(memoryStream);
		}
